(function($) {
    ...
    $('.slider-active-2').owlCarousel({
        ...
        animateOut: 'fadeOut',
        animateIn: 'fadeIn',
        navText: ['<img src="Content/assets/img/icon-img/57.png"> next', 'prev <img src="Content/assets/img/icon-img/58.png">'],
        item: 1,
        responsive: {
            0: {
                items: 1
    ...
    $('.popular-product-active').owlCarousel({
        ...
        item: 4,
        margin: 57,
        navText: ['<img src="Content/assets/img/icon-img/left.png">', '<img src="Content/assets/img/icon-img/right.png">'],
        responsive: {
            0: {
                items: 1
            },
    ...
    $(function() {
        sliderrange.slider({
            ...
            slide: function (event, ui) {
                amountprice.val("" + parseInt(ui.values[0]).toLocaleString() + " - " + parseInt(ui.values[1]).toLocaleString());
            }
        });
        amountprice.val("" + parseInt(sliderrange.slider("values", 0)).toLocaleString() +
            " - " + parseInt(sliderrange.slider("values", 1)).toLocaleString());
    });
